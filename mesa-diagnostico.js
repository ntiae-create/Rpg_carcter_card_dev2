...
function atualizarStatusRealtime() {
    ...
    /*
     * mesa.js atualiza o estado interno quando
     * o canal Realtime é criado.
     *
     * Procuramos também o canal exposto
     * indiretamente através do estado/global.
     */
...
function inicializar() {
    ...
    if (sincronizarBotao) {
        ...
        sincronizarBotao.addEventListener(
            "click",
            sincronizarAgora
        );
    ...
    if (atualizarBotao) {
        ...
        atualizarBotao.addEventListener(
            "click",
            atualizarDiagnostico
        );
